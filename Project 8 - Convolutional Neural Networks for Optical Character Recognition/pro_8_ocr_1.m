...
% --------------------------------------------------------------------------
%
% Train a CNN to recognize user input patterns to be used to unlock a 
% smart phone. Have the CNN recognize 5 different input patterns. In
% total, the CNN should have 5 outputs.
%
% For examples of unlock patterns, go to this link:
